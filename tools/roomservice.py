...
# Copyright (C) 2012-2015, Caf Project
#
...
custom_local_manifest = ".repo/local_manifests/caf_manifest.xml"
custom_default_revision = "n"
custom_dependencies = "caf.dependencies"
org_manifest = ""  # leave empty if org is provided in manifest
org_display = "CAF"  # needed for displaying
